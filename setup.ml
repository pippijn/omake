...
(* OASIS_START *)
(* DO NOT EDIT (digest: deea30fd229f0632a5708a7201c3112c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["omake_shell_sys.c"; "readline.c"];
                      bs_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "omake_cutil";
                           InternalLibrary "omake_clib"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "omake_main.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\251_V\006\164,\b\245\168\019\160\168\202E\143\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
