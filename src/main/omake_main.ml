...
module Builtins = struct
  open Omake_builtin_arith
  open Omake_builtin_base
  open Omake_builtin_file
  open Omake_builtin_fun
  open Omake_builtin_io
  open Omake_builtin_io_fun
  open Omake_builtin_object
  open Omake_builtin_rule
  open Omake_builtin_shell
  open Omake_builtin_sys
  open Omake_builtin_target
  open Omake_builtin_test
end
